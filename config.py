...
def argparser():
    ...
    parser.add_argument('--dataset_dir', default='./data/np_prepro/', help='dataset path')
    ...
    parser.add_argument('--user_count', default=55223, help='number of users', type=int)
    parser.add_argument('--item_count', default=17389, help='number of items', type=int)
    parser.add_argument('--cate_count', default=3065, help='number of categories', type=int)
